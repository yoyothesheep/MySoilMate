                    ...
                    <div className="absolute inset-0 rounded-full bg-white border-2 border-green-400 shadow-md overflow-hidden">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (
                            img.src.includes("/api/plants/") &&
                            plant.plant.imageUrl
                          ) {
                            img.src = plant.plant.imageUrl;
                          } else {
                            img.src =
                              "https://via.placeholder.com/100x100?text=Plant";
                          }
                        }}
                      />
                    </div>
            ...
            {selectedPlants.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm mt-2">
                  Browse the plant catalog and select plants to add to your
                  garden.
                </p>
              </div>
            ) : (
              <div className="space-y-3">
                {selectedPlants.map((plant) => (
                  <div
                    key={plant.id}
                    className="flex group relative bg-gray-50 rounded-lg overflow-hidden shadow-sm transition-all hover:shadow cursor-pointer"
                  >
                      ...
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (
                            ...
                            img.src =
                              "https://via.placeholder.com/100?text=Plant";
                          }
                        }}
                      />
                    </div>
