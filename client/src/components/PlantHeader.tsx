...
export function PlantHeader({ onSearch }: PlantHeaderProps) {
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0 flex items-center">
              ...
              <span className="text-lg font-semibold text-gray-900">PlantViz</span>
            </div>
          </div>
          ...
          <div className="flex-1 max-w-2xl px-4 md:px-8">
            <div className="relative w-full mt-3">
              ...
              <Input
                ...
                placeholder="Search plants by name, species or care needs..."
                value={searchTerm}
          ...
          <div className="flex items-center">
            ...
            <button className="ml-2 p-2 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="none"
